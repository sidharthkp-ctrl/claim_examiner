...
let ClaimsCaseContextPage = class ClaimsCaseContextPage extends LightDomElement {
    ...
    _openClaim(claimId) {
        this.dispatchEvent(new CustomEvent('open-claim', {
          ...
          <claims-card title="Claims filed under this case" icon=${MaterialIcons.files}>
            <div class="overflow-x-auto">
              <table class="w-full border-collapse text-left">
                ...
                <tbody>
                  ${this.claimsInCase.map((claim) => html `
...
], ClaimsCaseContextPage.prototype, "caseId", void 0);
__decorate([
    property({ type: String })
], ClaimsCaseContextPage.prototype, "insuredName", void 0);
__decorate([
    property({ type: String })
], ClaimsCaseContextPage.prototype, "eventDate", void 0);
__decorate([
    property({ type: String })
], ClaimsCaseContextPage.prototype, "eventDateLabel", void 0);
__decorate([
    property({ type: Array })
...
], ClaimsCaseContextPage.prototype, "claimGroup", void 0);
