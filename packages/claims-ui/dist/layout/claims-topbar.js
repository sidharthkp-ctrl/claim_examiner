...
let ClaimsTopbar = class ClaimsTopbar extends LightDomElement {
    constructor() {
        ...
        this.portalLabel = 'Claims Workbench';
    ...
    render() {
      ...
      >
        <nav class="text-[12px] text-muted-foreground flex items-center gap-1 min-w-0 shrink flex-wrap">
          ${this.showHomeLink
            ? html `
                <a href="/" class="text-[#185FA5] hover:underline font-medium" @click=${this._goHome}
                  >Portals</a
                >
                <span>/</span>
                <span class="text-[#185FA5]">${this.portalLabel}</span>
                <span>/</span>
              `
            : html `
...
__decorate([
    property({ type: String })
], ClaimsTopbar.prototype, "portalLabel", void 0);
__decorate([
    property({ type: Boolean })
], ClaimsTopbar.prototype, "showHomeLink", void 0);
