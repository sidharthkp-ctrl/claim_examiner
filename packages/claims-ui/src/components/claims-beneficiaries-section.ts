...
export class ClaimsBeneficiariesSection extends LightDomElement {
  @property({ type: Array }) beneficiaries: ClaimsBeneficiary[] = []
  @property({ type: String }) mode: BeneficiariesDisplayMode = 'full'
  @property({ type: Boolean }) showTax = true
  @property({ type: String }) title = 'Beneficiaries'
  @property({ type: String }) description = ''

  private _renderTaxBlock(b: ClaimsBeneficiary) {
    const tax = b.tax
    return html`
  ...
  private _renderBeneficiaryCard(b: ClaimsBeneficiary) {
